...
\begin{subequations}
\begin{align}
  F'(U,V)(H,K) &= \langle R(U,V),H\Sigma V^{T} + U\Sigma K^{T} - P(H\Sigma V^{T} + U\Sigma K^{T})\rangle  \label{eq:aa} \\
  &= \langle R(U,V),H\Sigma V^{T} + U\Sigma K^{T}\rangle \nonumber \\
  &= \langle R(U,V)V\Sigma^{T},H\rangle + \langle \Sigma^{T}U^{T}R(U,V),K^{T}\rangle. \label{eq:bb} \nonumber
\end{align}
\end{subequations}
...
\begin{multline} \label{eq:ml}
  g(U,V) = \biggl( \frac{R(U)V\Sigma^{T}U^{T} - U\Sigma V^{T}R(U)^{T}}{2}U + \frac{R(U)^{T}U\Sigma V^{T}-V \Sigma^{T}U^{T}R(U)}{2}V,\\
   \frac{R(U)^{T}U\Sigma V^{T}-V \Sigma^{T}U^{T}R(U)}{2}V - \frac{R(U)V\Sigma^{T}U^{T} - U\Sigma V^{T}R(U)^{T}}{2}U \biggr).
\end{multline}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.49\columnwidth]{example_fig1}

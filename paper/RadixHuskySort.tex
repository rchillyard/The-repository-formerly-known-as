...
The English and Chinese strings come from the Leipzig Corpora Collection~\cite{GOLDHAHN12.327}; for
each we take the appropriate \emph{sentences.txt} file and break it into strings as shown in
Listing~\ref{lst:DS}.

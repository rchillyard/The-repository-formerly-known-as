...
\textit{Arrays.parallelSort}, so the serial comparison is the conservative one to draw against
...
thread counts, not against \textit{Arrays.parallelSort}, which we have not measured on the machine of
record.

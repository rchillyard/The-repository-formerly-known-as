...
Width alone does not buy perfection, though: only a bounded domain admits a perfect fixed-width code
at all, and a coder limited by its own information rather than by its width --- pinyin, whose few
hundred syllables leave true homonyms however many characters are encoded --- gains nothing from
extra bits.

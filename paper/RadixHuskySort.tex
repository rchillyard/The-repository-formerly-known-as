...
This section describes RadixHuskySort, which makes it so (Algorithm ~\ref{alg:the_alg5}).
...
Step 1b requires the definition of a 64-bit husky code (refer to Algorithm ~\ref{alg:the_alg2}).

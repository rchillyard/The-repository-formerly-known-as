...
HuskySort's advantage is specific to a kind of workload rather than universal, and needs all of
...
a comparison costing more than a machine-word check --- strings, arbitrary-precision numbers
and multi-field records, as opposed to \textit{int}, \textit{long} or \textit{double},
where dual-pivot quicksort wins outright;
and no cores going spare, since \mbox{\textit{Arrays.parallelSort}} would use them
(\S~\ref{sec:parallel-baseline}).

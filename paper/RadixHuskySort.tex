...
\renewcommand{\labelenumi}{\alph{enumi}}
    ...
    \end{enumerate}
\item {}Sort array \emph{longs} using quicksort --- in practice dual-pivot, with an insertion-sort
cutoff and the heapsort fallback of \S~\ref{sec:background} ---
in such a way that when elements $i, j$ of \emph{longs} are exchanged, then elements $i, j$ of $xs$ are also exchanged;
\item {}Finally, when quicksort is finished and, \emph{if necessary},

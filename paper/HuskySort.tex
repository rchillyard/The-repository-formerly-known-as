...
$N = 198{,}900$: 6.2\%, 22.8\% and 24.2\% of total running time, intervals non-overlapping throughout.
...
The shape is a threshold rather than a trend --- a three- to fivefold rise between the first two sizes,
...
First, $k_3$ is not a constant: it varies fivefold across three sizes on one machine,

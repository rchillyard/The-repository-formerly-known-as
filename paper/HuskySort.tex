...
%% ANONYMISATION: this URL must become an Anonymous GitHub link before submission -- it names its
%% owner. See "0i. The repository link" in Paper edits pending.md. It was moved here from an author
%% footnote, which was deleted along with the other two.

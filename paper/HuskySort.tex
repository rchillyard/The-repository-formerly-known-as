...
The derivation of that comparison is a counting argument rather than a measurement, and it rests on
one coefficient we estimated rather than measured; it is set out in \S~\ref{sec:qhs-analysis}.
Its conclusion is that QuickHuskySort's linear phase is relatively costly at small $N$ and is soon
swamped by the comparisons saved in the linearithmic phase, with a break-even against merge sort at
$N = 4$ and a widening advantage thereafter.

...
%% acmart's journal page style prints "ACM Trans. Graph., Vol. , No. , Article ." in the footer of
%% every page. With the journal fields blanked that reads as a broken ACM footer rather than a
%% suppressed one, so the plain style replaces it with a bare page number.
\pagestyle{plain}
%% maketitle sets the first page's style itself, so it needs overriding separately.
\thispagestyle{plain}
%%

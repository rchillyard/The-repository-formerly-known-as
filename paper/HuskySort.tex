...
And while it measured the cleanup pass in one respect, choosing between Timsort and insertion sort (\S~\ref{sec:cleanup-choice}),
it did not precisely measure what that pass costs: of $p_{crit}$, the quantity

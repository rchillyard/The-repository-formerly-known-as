...
\textit{unicodeToLong} and \textit{asciiToLong} are both thin wrappers around one packing loop,
differing only in which bit-width, maximum length, and mask constant they pass in;

...
\newif\ifdraftstamp
\draftstamptrue
%% \time is TeX's minutes-since-midnight; these two turn it into HH:MM, zero-padded.
\newcommand{\stamphour}{\ifnum\number\numexpr\time/60\relax<10 0\fi\number\numexpr\time/60\relax}
\newcommand{\stampminute}{\ifnum\number\numexpr\time-(\time/60)*60\relax<10 0\fi\number\numexpr\time-(\time/60)*60\relax}
\newcommand{\revisionstamp}{\the\year-\ifnum\the\month<10 0\fi\the\month-\ifnum\the\day<10 0\fi\the\day\ \stamphour:\stampminute}
%%
%% Submission ID.
...
\ifdraftstamp
  ...
  \def\ps@plain{%
    ...
    \def\@oddfoot{\reset@font\footnotesize
      draft \revisionstamp\hfil\thepage\hfil\phantom{draft \revisionstamp}}%

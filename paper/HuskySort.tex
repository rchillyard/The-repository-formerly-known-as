...
under JMH, on English and Chinese text, in natural Unicode order so that every sort compared
...
with non-overlapping 99.9\% confidence intervals in both cases.

...
Three machines appear in this paper, and Table ~\ref{tab:SysEnv} lists all three.
...
It does: HuskySort, and now radix sort, beat the system sort on all three,
...
\begin{table*}
  \caption{The three benchmark environments. Machine A supplies the comparison-sort results of
    ...
    of record, every figure quoted in this paper.}
  \label{tab:SysEnv}
...
The measurements were reproduced qualitatively on machines A and B of Table ~\ref{tab:SysEnv},

...
The top-level \textit{sort} method follows the three steps of \S~\ref{sec:overview} directly, and the
default \textit{huskyEncode} is Algorithm ~\ref{alg:the_alg2} above;
rather than repeat either as Java source, we describe only the details those do not already cover.

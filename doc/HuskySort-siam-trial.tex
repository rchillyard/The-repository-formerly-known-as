...
%% Preamble per SIAM's own example_doublecolumn.tex (022425 package).
\documentclass[twoside,leqno,twocolumn]{article}
\usepackage[letterpaper]{geometry}
%% SHIM: siamproceedings.sty calls \AddToHook, added to the LaTeX kernel in 2020-10-01. This machine
%% runs TeX Live 2020, kernel 2020-02-02. All ten uses are \crefalias declarations for theorem
%% environments this paper does not contain. Remove when building on a current distribution.
\makeatletter

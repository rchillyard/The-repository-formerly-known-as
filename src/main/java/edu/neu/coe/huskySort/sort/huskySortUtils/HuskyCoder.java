...
public interface HuskyCoder<X> {
    ...
    /**
     * Method to determine if this Husky Code generated by huskyEncoder is perfectly/uniquely encoded or not.
     *
     * @return true if the resulting Husky Code perfectly encodes the string.
     */
    default boolean isPerfectlyEncoded(long huskyCode){ return (huskyCode & tooLongMask) == 0; }

    long tooLongMask = 1L << 63;
}
